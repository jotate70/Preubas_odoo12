...
class AccountInvoice(models.Model):
    ...
    ei_xml_name = fields.Char(string="Nombre del archivo xml", copy=False)
    ...
    def write_response(self, json_response):
        try:
            ...
            for rec in self:
                ...
                rec.ei_name = json_request['xml_name']
    ...
    #            'xml_name': 'xxxxxxxxxxxxxxxx', 'zip_name': 'xxxxxxxxxxxxxxxxxxx.zip',
    ...
    #            'status_description': '', 'status_message': '', 'xml_name': '',
